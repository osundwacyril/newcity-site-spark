...
export const GrandOpeningBanner = () => {
  ...
  return (
    <div className="fixed top-[88px] left-0 right-0 z-40 bg-gradient-to-r from-primary via-primary-glow to-primary text-primary-foreground py-3 px-4 shadow-lg overflow-hidden animate-slide-in-right">
