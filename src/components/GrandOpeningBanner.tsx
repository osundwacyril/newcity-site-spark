...
export const GrandOpeningBanner = () => {
  ...
  return (
    <div className="fixed top-[140px] left-0 right-0 z-40 bg-gradient-to-r from-primary via-primary-glow to-primary text-primary-foreground py-3 px-4 shadow-lg overflow-hidden animate-slide-in-right">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-1 overflow-hidden">
            ...
            <div className="whitespace-nowrap animate-marquee text-sm md:text-base">
              ...
              <span>Only 1 Day to go! Hurry, only a few slots remaining!</span>
              <span className="mx-4">|</span>
